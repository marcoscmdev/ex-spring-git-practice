...
public class MovieController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get a movie by id", description = "Retorna la pelicula que coincide con el id", responses = {
    ...
    public ResponseEntity<String> generateMoviesSuggestion(@RequestBody SuggestRequestDto suggestRequestDto) {
        return ResponseEntity.ok(this.platziPlayAiService.generateMoviesSuggestion(suggestRequestDto.userPref()));
    }
